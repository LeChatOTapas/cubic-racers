...
public abstract class KartAbstract extends Entity {
    ...
    public boolean getIsPressingKeyUp() { return this.entityData.get(isPressingKeyUp); }
    public void setIsPressingKeyUp(boolean value) {
        this.entityData.set(isPressingKeyUp, value);
    }

    public boolean getIsPressingKeyDown() { return this.entityData.get(isPressingKeyDown); }
    public void setIsPressingKeyDown(boolean value) {
        this.entityData.set(isPressingKeyDown, value);
    }

    public boolean getIsPressingKeyLeft() { return this.entityData.get(isPressingKeyLeft); }
    public void setIsPressingKeyLeft(boolean value) {
        this.entityData.set(isPressingKeyLeft, value);
    }

    public boolean getIsPressingKeyRight() { return this.entityData.get(isPressingKeyRight); }
    public void setIsPressingKeyRight(boolean value) {
        this.entityData.set(isPressingKeyRight, value);
    }

    public boolean getIsPressingKeyDrift() { return this.entityData.get(isPressingKeyDrift); }
    public void setIsPressingKeyDrift(boolean value) {
        this.entityData.set(isPressingKeyDrift, value);
    }

    public boolean getIsPressingKeyItem() { return this.entityData.get(isPressingKeyItem); }
    public void setIsPressingKeyItem(boolean value) {
        this.entityData.set(isPressingKeyItem, value);
    }

    public boolean getIsPressingKeyDelta() { return this.entityData.get(isPressingKeyDelta); }
    public void setIsPressingKeyDelta(boolean value) {
        this.entityData.set(isPressingKeyDelta, value);
    }

    public boolean getPreviousPressingKeyDelta() { return this.entityData.get(previousPressingKeyDelta); }
    ...
    public boolean getIsDrifting() { return this.entityData.get(isDrifting); }
    public void setIsDrifting(boolean value) {
        this.entityData.set(isDrifting, value);
    }

    public String getDriftingSens() { return this.entityData.get(driftingSens); }
    public void setDriftingSens(String value) {
        this.entityData.set(driftingSens, value);
    }

    public float getDriftingTime() { return this.entityData.get(driftingTime); }
    public void setDriftingTime(float value) {
        this.entityData.set(driftingTime, value);
    }

    public float getDriftTimeBoost() { return this.entityData.get(driftTimeBoost); }
    public void setDriftTimeBoost(float value) {
        this.entityData.set(driftTimeBoost, value);
    }

    public float getTimeBoost() { return this.entityData.get(timeBoost); }
    ...
    public boolean getDeltaOn() { return this.entityData.get(deltaOn); }
    public void setDeltaOn(boolean value) {
        this.entityData.set(deltaOn, value);
    }

    public int getDeltaAnimationState() { return this.entityData.get(deltaAnimationState); }
    public void setDeltaAnimationState(int value) {
        this.entityData.set(deltaAnimationState, value);
    }

    public int getWaterAnimationState() { return this.entityData.get(waterAnimationState); }
    public void setWaterAnimationState(int value) {
        this.entityData.set(waterAnimationState, value);
    }

    public float getFallSpeed() { return this.entityData.get(fallSpeed); }
    public void setFallSpeed(float value) {
        this.entityData.set(fallSpeed, value);
    }

    public float getPourcentageInclinaison() { return this.entityData.get(pourcentage_inclinaison); }
    public void setPourcentageInclinaison(float value) {
        this.entityData.set(pourcentage_inclinaison, value);
    }

    public float getActualRotationWheels() { return this.entityData.get(actual_rotation_wheels); }
    ...
    public boolean getCanMove() { return this.entityData.get(canMove); }
    public void setCanMove(boolean value) {
        this.entityData.set(canMove, value);
    }

    public float getStunRotation() { return this.entityData.get(stunRotation); }
    ...
    public String getKartItem() { return this.entityData.get(kartItem); }
    public void setKartItem(String value) {
        this.entityData.set(kartItem, value);
    }

    public boolean getIsInvinsible() { return this.entityData.get(isInvinsible); }
    public void setIsInvinsible(boolean value) {
        this.entityData.set(isInvinsible, value);
    }

    public float getStarSpeedBoost() { return this.entityData.get(starSpeedBoost); }
    public void setStarSpeedBoost(float value) {
        this.entityData.set(starSpeedBoost, value);
    }

    public float getTimeStar() { return this.entityData.get(timeStar); }
    public void setTimeStar(float value) {
        this.entityData.set(timeStar, value);
    }

    public boolean getIsKlaxoning() { return this.entityData.get(isKlaxoning); }
